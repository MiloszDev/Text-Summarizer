...
class ModelEvaluation:
    ...
    def __init__(self, config: ModelEvaluationConfig):
        ...
        self.model = T5ForConditionalGeneration.from_pretrained(self.config.model_path).to(self.device)
    ...
    def summarize_text(self, text):
            ...
            summary_ids = self.model.generate(input_ids, max_length=128, min_length=50, length_penalty=2.0, num_beams=4, early_stopping=True)
    ...
    def evaluate_model(self, samples):
        ...
        predictions = [self.summarize_text(self.tokenizer.decode(input_id, skip_special_tokens=True)) for input_id in input_ids]
