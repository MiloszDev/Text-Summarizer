...
from src.settings.constants import CONFIG_FILE_PATH, PARAMS_FILE_PATH
...
class ConfigurationManager:
    ...
    def __init__(
        ...
        try:
            ...
            raise RuntimeError(
                f"Error loading configuration files or creating directories: {e}"
            )
    ...
    def get_data_ingestion_config(self) -> DataIngestionConfig:
        ...
        try:
            ...
            return DataIngestionConfig(datasets=config.datasets)
    ...
    def get_data_preprocessing_config(self) -> DataPreprocessingConfig:
        ...
        try:
            ...
            raise RuntimeError(f"Error getting data preprocessing configuration: {e}")
